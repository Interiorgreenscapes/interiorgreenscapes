...
const categories = [
  ...
  },
  {
    ...
    gallery: [
      ...
      `${BASE}images/lobby-new-1.jpg`,
      `${BASE}images/lobby-new-2.jpg`,
      `${BASE}images/lobby-new-3.jpg`,
      `${BASE}images/lobby-new-4.jpg`,
      `${BASE}images/lobby-new-5.jpg`,
      `${BASE}images/lobby-new-6.jpg`,
      `${BASE}images/lobby-new-7.jpg`,
      `${BASE}images/lobby-new-8.jpg`,
    ],
  },
];
